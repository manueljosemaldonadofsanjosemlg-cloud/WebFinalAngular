# Origen Network Store - NUI Angular

Este proyecto es una aplicación web moderna desarrollada con Angular, diseñada específicamente como una interfaz de tienda virtual (NUI) para el ecosistema de **Origen Network**. La aplicación combina una estética premium con una funcionalidad robusta de e-commerce y gestión.
...
*   **Diseño NUI Premium**: Interfaz inspirada en el servidor Origen, con fondos animados de partículas, degradados elegantes y una escala optimizada mediante unidades `vh`.
